            ...
            <div class="dropdown d-inline-block user-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="#"><i class="ri-lock-unlock-line align-middle me-1"></i> Lock
                        screen</a>
                    <select class="dropdown-item changeLang">
                        <option class="dropdown-item {{ session()->get('locale') == 'fa' ? 'dropdown-active' : '' }}"
                            value="fa" {{ session()->get('locale') == 'fa' ? 'selected' : '' }}><img
                                src="{{ asset('frontend/assets/imgs/theme/flag-fr.png') }}" alt="" />Farsi
                        </option>
                        <option class="dropdown-item {{ session()->get('locale') == 'en' ? 'dropdown-active' : '' }}"
